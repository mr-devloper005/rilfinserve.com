...
export const editableRootStyle = {
  ...
  '--slot4-page-text': '#11142f',
  '--slot4-panel-bg': '#f7f8fc',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#606783',
  '--slot4-soft-muted-text': '#8f94aa',
  '--slot4-accent': '#3f6ff2',
  '--slot4-accent-fill': '#3f6ff2',
  '--slot4-accent-soft': '#e8efff',
  '--slot4-dark-bg': '#11142f',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#eef1f7',
  '--slot4-cream': '#ffffff',
  '--slot4-warm': '#fbfcff',
  '--slot4-lavender': '#f3f6ff',
  '--slot4-gray': '#f7f8fc',
  '--slot4-body-gradient': 'linear-gradient(180deg, #ffffff 0%, #fbfcff 48%, #f7f8fc 100%)',
} as CSSProperties
...
export const editableDesignContract = {
  ...
  button: {
    primary: `inline-flex items-center justify-center rounded-md ${editablePalette.accentBg} px-7 py-3.5 text-sm font-semibold text-white shadow-[0_10px_22px_rgba(63,111,242,0.25)] transition hover:opacity-90`,
...
export const aiLayoutRules = [
  ...
  'Use compact centered sections and practical directory cards inspired by marketplace listing pages.',
